...
- Name: apps\shell\e2e\federation.spec.ts >> Remote Loading Performance >> should load services remote within acceptable time
- Location: apps\shell\e2e\federation.spec.ts:232:7
