...
- [x] Isolated candidate Storybook Playwright coverage added at `apps/qa-remote/e2e/button-candidate.storybook.spec.ts`.
...
2. **Visual styling system**
   ...
   - render the Button through the same token contract in Figma, Storybook, the Component Lab, and the shell;
...
- [x] Include the candidate in the Component Lab.
...
- [x] Candidate included in the Component Lab component.
- [x] Static Storybook validation script updated to reference the candidate primary story.
- [x] Isolated Storybook Playwright spec created at `apps/qa-remote/e2e/button-candidate.storybook.spec.ts`.
...
- [x] Component Lab TypeScript test passed locally.
...
- [x] Current Storybook title is `Design System/Experiments/Button UP`.
- [x] Storybook sidebar order places `Design System / Experiments` above `Design System / Acceptance`.
...
- [x] Isolated Storybook Playwright spec exists at `apps/qa-remote/e2e/button-candidate.storybook.spec.ts`.
...
## Component Lab checklist

### Candidate display

- [x] Candidate was added locally to the Component Lab.
- [ ] Verify the Component Lab route after commit.
...
- [ ] Candidate renders when Component Lab runs independently.
- [ ] Candidate renders when Component Lab is mounted through the shell.
...
- [x] Spec added at `apps/qa-remote/e2e/button-candidate.storybook.spec.ts`.
...
- [ ] Mount Component Lab through shell.
...
- [ ] Open the Component Lab comparison page.
...
- [ ] Independent Component Lab proof.
- [ ] Shell-mounted proof.
