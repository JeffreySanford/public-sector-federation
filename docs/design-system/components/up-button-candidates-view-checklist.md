# QA Candidates View — UP Button Comparison Checklist

## Relationship to the main candidate plan

This document is the UI implementation companion to:

- [`up-button-candidate-integration-plan.md`](./up-button-candidate-integration-plan.md)
...
This document focuses specifically on the requested **Candidates** view in the QA remote.

## Confirmed direction

- [X] Add a third top-level QA view named **Candidates**.
- [X] Place the **Candidates** button to the right of **Performance Tracking**.
...
- [X] Use the new **Candidates** view as the review surface for experimental design-system components.
...
- [X] Do not make the QA remote depend on Zeroheight being online.

## Current QA navigation pattern

The current QA remote begins with two view buttons:
...
- [ ] Add the **Candidates** Button immediately after **Performance Tracking**.
...
- [ ] Choose one folder convention that matches the current QA remote organization.
- [ ] Do not create both structures.

## Candidates view purpose

The Candidates view is a controlled review surface for components that have not yet been promoted into the stable public-sector design system.
...
- [ ] Add a page tag such as `QA Candidate Lab`.
- [ ] Use the heading `Component Candidates`.
...
<header class="qa-header candidates-header">
  <span class="qa-tag">QA Candidate Lab</span>
...
The QA remote already supports neutral, vibrant, pastel, light, and dark review.
...
- [ ] Do not block the Candidates view when Storybook is unavailable.
...
- [ ] The Candidates heading is available immediately after activation.
...
- [ ] Confirm the top buttons appear in this order:
  ...
  3. [ ] Candidates
- [ ] Activate Candidates.
- [ ] Verify `Component Candidates` heading.
...
- [ ] Run axe on the Candidates view.

### Shell-composed QA remote
...
- [ ] Run axe on the shell-composed Candidates view.

## Storybook relationship

The Candidates view does not replace Storybook.
...
The Candidates view does not replace Zeroheight.
...
- [ ] Zeroheight links back to the Candidates view when a stable deployed QA URL exists.
- [ ] Both surfaces use the same Candidate lifecycle label.

## Definition of done for the first Candidates view

- [ ] Third **Candidates** navigation Button appears to the right of **Performance Tracking**.
- [ ] Existing QA Components view is unchanged.
- [ ] Existing Performance Tracking view is unchanged.
- [ ] Candidates view renders through the existing active-tab pattern.
- [ ] Candidates content is extracted into a maintainable component.
...
5. [ ] Add the conditional Candidates view container.
...
20. [ ] Record the Candidates view as integration evidence in the main candidate plan and Zeroheight page.

## Final decision

The requested **Candidates** view is the correct place for the old-versus-new comparison.
...
QA Candidates view
  -> stable-versus-candidate comparison inside the real QA remote
...
The first Candidates view remains deliberately narrow: it evaluates one UP-inspired Button candidate and does not convert the rest of the public-sector design system.
