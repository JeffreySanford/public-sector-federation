...
const pages = [
  ...
  {
    zeroheightPage: 'Components / Button / Button Candidate / Introduction',
    source: 'docs/design-system/components/button-candidate.md',
    output: 'components-button-candidate-introduction.md',
  },
  {
    zeroheightPage: 'Components / Button / Button Candidate / Overview',
    source: 'docs/design-system/components/button-candidate-overview.md',
    output: 'components-button-candidate-overview.md',
  },
  {
    zeroheightPage: 'Components / Button / Button Candidate / Design & Tokens',
    source: 'docs/design-system/components/button-candidate-design-tokens.md',
    output: 'components-button-candidate-design-tokens.md',
  },
  {
    zeroheightPage: 'Components / Button / Button Candidate / Developer',
    source: 'docs/design-system/components/button-candidate-developer.md',
    output: 'components-button-candidate-developer.md',
  },
  {
    zeroheightPage: 'Components / Button / Button Candidate / Validation',
    source: 'docs/design-system/components/button-candidate-validation.md',
    output: 'components-button-candidate-validation.md',
  },
  {
