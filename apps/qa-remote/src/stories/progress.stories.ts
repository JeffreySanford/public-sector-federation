...
export const BelowMinimumIsBounded: Story = { args: { value: -25, ariaLabel: 'Bounded to zero percent' } };
export const AboveMaximumIsBounded: Story = { args: { value: 140, ariaLabel: 'Bounded to one hundred percent' } };
