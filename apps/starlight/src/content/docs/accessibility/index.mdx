...
Read directly from the generated manifest at build time, so it always matches
`packages/ui-patterns/generated/component-manifest.json`.

### Button

<AccessibilityStatus componentId="ps-button" />

### Select

<AccessibilityStatus componentId="ps-select" />

### Dialog

<AccessibilityStatus componentId="ps-dialog" />
