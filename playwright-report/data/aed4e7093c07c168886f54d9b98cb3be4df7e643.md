...
Locator: locator('#storybook-preview-iframe').locator('iframe').contentFrame().locator('button').filter({ hasText: /Previous/i })
Expected: visible
Timeout: 10000ms
...
```yaml
- log
- log: Component test completed successfully.
- banner "Storybook":
